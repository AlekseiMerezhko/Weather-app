  ...
  return (
    <nav className="flex items-center lg:justify-between justify-center flex-wrap bg-teal-500 p-6">
      ...
      <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
        <div className="text-sm lg:flex-grow flex lg:flex-row flex-col items-center">
          <Link
            className="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white lg:mr-4"
            to="/"
          >
            Home
          </Link>
